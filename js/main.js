...
(function($) {
	...
	function  computeBMI () {
		...
		if (output < 18.5) {
			document.getElementById("bmi-result").value = output + " (Abaixo do normal)";
		} else if (output >= 18.5 && output <= 25) {
			document.getElementById("bmi-result").value = output + " (Normal)";
		} else if (output >= 25 && output <= 30) {
			document.getElementById("bmi-result").value = output + " (Sobrepeso)";
		}else if (output > 30) {
			document.getElementById("bmi-result").value = output + " (Obesidade)";
		} else {
